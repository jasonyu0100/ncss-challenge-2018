...
class Dealer:
  ...
  def availableComboBeaters(hand,comboType):
    ...
    for currentComboType in playableComboTypes:
      if currentComboType in {1,2,3}:
        if currentComboType == 1: return Dealer.getAllCombos(hand,1)
        elif currentComboType == 2: return Dealer.getAllCombos(hand,2)
        elif currentComboType == 3: return Dealer.getAllCombos(hand,3)
  ...
  def getComboType(combo):
    if len(combo) == 0: return None
      ...
      elif len(combo) == 2: return 2
      elif len(combo) == 3: return 3
